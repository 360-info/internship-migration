...
testp1 <- ctEx1 %>%
  ...
  ylab("Percentage") +
  xlab("Type of Exploits") +
  labs(fill='Gender Groups') + 
  ggtitle("Distribution of Human Trafficking Victims Exploitted",
...
fd <- ct2b1 %>%
  ...
  labs(alpha = "No. of Victims Reported",
       title = "Top 10 Routes of Human Trafficking Victims",
       subtitle = "Reported case from 2002 to 2019") +
  theme_360() +
