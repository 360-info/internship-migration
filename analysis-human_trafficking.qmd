...
testp1 <- ctEx1 %>%
  ...
  scale_x_discrete(labels = c("Sexual and labour exploitation" = "Sexual and\nlabour exploitation")) +
  coord_flip() +
  ylab("Percentage") +
  xlab("Type of Exploits") +
