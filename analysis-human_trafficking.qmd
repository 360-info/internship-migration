...
Reminder: Most of the code shown below is to demonstrate the derivation of final output. If interested in the code for final output only, please check section @sec-finald and @sec-finalf.
...
### Final Output: Distribution of Victims {#sec-finald}
...
### Final Output: Victim Flow {#sec-finalf}
