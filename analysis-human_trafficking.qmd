...
testp1 <- ctEx1 %>%
  ...
  geom_col(aes(fill = genderGroup, 
               group = typeOfExploitConcatenated),colour = "white", width = 0.7) +
  theme_360() +
  scale_fill_manual(values = colourGP) +
  coord_flip() +
  ylab("Percentage") +
  xlab("Type of Exploits") +
  labs(title = "Distribution of Human Trafficking Victims",
       subtitle = "Reported case from 2002 to 2019 ",
       caption = paste(
...
```{r}
t1 <- grobTree(textGrob("Origin Country",
                        gp=gpar(fontsize=12, fontface="bold")))

t2 <- grobTree(textGrob("Destination Country",
                        gp=gpar(fontsize=12, fontface="bold")))

palette1 <- c("#88CCEE", "#CC6677", "#7C9473", "#B66353",
              "#3896C4", "#FFDA66", "#55AD89", "#848282",
              "#B4E197", "#000000", "#6699CC", "#888888")

Okabe_Ito <- c("#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7", "#000000", "#888888")
...
fd <- ct2b1 %>%
  ...
  annotation_custom(t1,xmin=1,xmax=1,ymin=21500,ymax=Inf) +
  annotation_custom(t2,xmin=2,xmax=2,ymin=21500,ymax=Inf) +
  ylab("Number of Victims") +
  labs(title = "Human Trafficking Victim Flows",
       subtitle = paste(
         "Top 10 routes of human trafficking victims,",
         "from reported cases 2002-2019.",
         sep = "\n"),
       caption = paste(
         "**CHART:** Ruimin Lin, James Goldie, 360info",
         "**DATA:** Counter Trafficking Data Collaborative",
